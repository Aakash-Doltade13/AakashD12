...
public class AppearsNby2T 
{
	
		public static boolean Majority(int[] arr1, int arrSize, int x) 
		{
			int lastIndex = arrSize % 2 != 0 ? arrSize / 2 + 1 : arrSize / 2; 
